...
frontend on its local listener. The other domains retain separate APIs and
storage. A future server may route every API domain through one port.
...
The physical Kweb is `kweb.sqlite3` beside
